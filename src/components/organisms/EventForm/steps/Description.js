        ...
        <div className="row">
          <form id="Form" className="form-horizontal">
            ...
            <div className="form-group hoc-alert col-md-12 form-block-holder">
              ...
              <br />
              <div className="green">
                ... so StepZilla step Components can either use basic JS
                validation or Higer Order Component (HOC) based validation with
                react-validation-mixin.
              </div>
            </div>
          </form>
...
export default validation(strategy)(Description)
